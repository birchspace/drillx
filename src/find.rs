            ...
            rt.spawn_blocking({
                ...
                move || {
                    ...
                    loop {
                        ...
                        // 定期输出进度
                        if nonce % 400 == 0 {
                            print_status(i, nonce, best_difficulty, &timer);
                        }
...
// 打印线程状态的函数
fn print_status(thread_id: u64, nonce: u64, difficulty: u32, timer: &Instant) {
    println!(
        "Thread {}:, Nonce = {}, Best Difficulty = {}, Elapsed Time = {} secs",
        thread_id,
        nonce,
        difficulty,
